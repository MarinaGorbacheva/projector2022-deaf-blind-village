...
export const DeathBlindIs: FC = () => {
    ...
    return (
        <>
            <Page id="DeathBlindIs" pBottom>
                <Container>
                    <H2>КТО ТАКИЕ СЛЕПОГЛУХИЕ?</H2>
                </Container>
                <Container pNone page mtNone>
                    <PartnersItemTitle>
                        Слепоглухота — это одновременное нарушение слуха и зрения такой интенсивности, что одному из нарушенных чувств сложно компенсировать другое. При этом оба нарушения могут иметь разную степень выра женности. Иногда люди рождаются слепоглухими, иногда — становятся
                        с возрастом из-за генетических поломок, заболеваний или травм.
                    </PartnersItemTitle>
                </Container>
            </Page>
        </>

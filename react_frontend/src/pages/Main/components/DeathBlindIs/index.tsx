        ...
        <>
            <Page id="DeathBlindIs" pBottom>
                ...
                <Container pNone page mtNone>
                    <PartnersItemTitle>
                        Слепоглухота — это состояние одновременного нарушения слуха и зрения такой интенсивности, что одному из нарушенных чувств сложно компенсировать другое. При этом оба нарушения могут иметь разную степень выраженности. Иногда люди рождаются слепоглухими, иногда — становятся с возрастом из-за генетических поломок, заболеваний или травм.
                    </PartnersItemTitle>
                </Container>
            </Page>
        </>

        ...
        <>
            <Page id="Materials" pBottom>
                ...
                <Container pNone page mtNone>
                    <PartnersItemTitle>
                        На начало 2022 года в базе Фонда «Со-единение» содержатся данные о 4372 человеках с одновременными нарушениями слуха и зрения в России. Из них старше 18-ти лет — 3672 человека, старше 18-ти — 700 человек. У остальных 19-ти — возраст неизвестен.<br />
                        <br />
                        В ходе переписи респонденты заполняют подробную анкету: в данных есть статистика по количеству слепоглухих в регионах, степени нарушения слуха и зрения, возраста, трудоустроенности и множество другой информации. В рамках этого исследования мы выбрали наиболее интересные показатели и провели качественный анализ. <br />
                        <br />
                        Получилось шесть показателей, способных продемонстрировать масштабы проблемы:
                        <ul>
                            <li>
                                общее количество людей со слепоглухотой и их возраст,
                            </li>
                            <li>
                                количество детей со слепоглухотой,
                            </li>
                            <li>
                                выраженность проблемы в регионе,
                            </li>
                            <li>
                                степень потери зрения и слуха,
                            </li>
                            <li>
                                частота синдромов/диагнозов,
                            </li>
                            <li>
                                условия проживания: в семье, в детском доме или в ПНИ.
                            </li>
                        </ul>
                    </PartnersItemTitle>
                </Container>

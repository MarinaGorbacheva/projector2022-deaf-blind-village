        ...
        <>
            <Page id="DbVillageIs" pBottom>
                ...
                <Container pNone page mtNone>
                    <PartnersItemTitle>
                        Это медиапроект и исследование «Ясеневой поляны», основанное на уникальных данных Фонда «Со-единение». С 2014 года Фонд ведёт перепись слепоглухих людей. Ресурс будет полезен специалистам и сообществу — тифлопедагогам, сурдопедагогами, специальным психологам, взрослым слепоглухим и родителям детей со слепоглухотой. Кроме того, своей работой мы надеемся привлечь внимание большего количества людей и институтов власти к проблеме слепоглухоты в России.
                    </PartnersItemTitle>
                </Container>
            </Page>
        </>
